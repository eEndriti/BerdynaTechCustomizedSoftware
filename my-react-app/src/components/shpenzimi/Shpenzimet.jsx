...
export default function Shpenzimet() {
  ...
  return (
   <Container>
    <Row className='d-flex flex-column mx-5'>
        ...
        <NdryshoShpenzimin show = {showModalPerNdryshim} handleClose = {() => setShowModalPerNdryshim(false)} dataPerNdryshim = {dataPerNdryshim} />
